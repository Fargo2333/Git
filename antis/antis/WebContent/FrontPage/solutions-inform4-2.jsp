...
<div class="toppic">
	 ...
	 <div class="toppic-title left">
			...
			<span class="toppic-title-span">扶贫项目展示与申请</span>
			
		</div>
		<div class="right toppic-progress">
			<span><a href="${pageContext.request.contextPath}/FrontPage/solutions.jsp" class="w-white">扶贫绿色通道</a></span>
			<i class=" am-icon-arrow-circle-right w-white"></i>
			<span><a href="${pageContext.request.contextPath}/FrontPage/news-inform.jsp" class="w-white">扶贫项目展示与申请</a></span>
		</div>
	</div>
</div>
...
<div class="solution-inform">
	<div class=" solution-inform-content-all">
		<div class="solution-inform-content">
	      ...
	      <p class="solution-inform-content-words">曲木伍且（化名），一个帅气却又腼腆的大男孩，今年18岁，在西昌市交通学校就读汽修专业。
	</p>
	
	<p class="solution-inform-content-words">曲木伍且的家在四川省凉山彝族自治州美姑县乐约乡，一个位于大凉山深处的美丽乡村。山里的生活贫苦而单调，由于交通不便，很多人一辈子都没有走出过这片大山。和许多同龄的孩子一样，小时候的他也有着许多梦想——当一个老师，回来教村里的孩子，让大家不再因为没有老师而失学；也可以当一个医生，能给大家看病，让村里的人不再翻山越岭的到县城去治病，并能照顾得了肺结核的妈妈……
	</p>
