...
<div class="toppic">
	 ...
	 <div class="toppic-title left">
			...
			<span class="toppic-title-span">扶贫助学，结对助学</span>
			
		</div>
		<div class="right toppic-progress">
			<span><a href="${pageContext.request.contextPath}/FrontPage/service-center.jsp" class="w-white">爱心扶贫乐园</a></span>
			<i class=" am-icon-arrow-circle-right w-white"></i>
			<span><a href="${pageContext.request.contextPath}/FrontPage/service-center-inform2.jsp" class="w-white">扶贫助学，结对助学</a></span>
		</div>
	</div>
</div>
...
<div class="solution-inform">
	<div class=" solution-inform-content-all">
		<div class="solution-inform-content">
		          <p class="solution-inform-content-words">结对帮扶真情在，爱心助学暖人心。开展扶贫帮困爱心助学系列活动，为需要帮助的困难学生家庭送去温暖，而我们的爱心之路也不会因为活动的结束而终止，我们将会进一步深入困难学生的家庭生活，用我们的爱心给予他们前行的力量！
	</p>
