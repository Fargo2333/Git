...
<header class="am-topbar header">
  ...
  <div class="am-collapse am-topbar-collapse right" id="doc-topbar-collapse">
    ...
    <div class=" am-topbar-left am-form-inline am-topbar-right" role="search">
      ...
      <li class="hw-menu-active"><a href="${pageContext.request.contextPath}/FrontPage/solutions.jsp">解决方案</a></li>
      <li><a href="${pageContext.request.contextPath}/FrontPage/product-show.jsp">产品展示 </a></li>
      <li><a href="${pageContext.request.contextPath}/FrontPage/customer-case.jsp">客户案例</a></li>
      <li><a href="${pageContext.request.contextPath}/FrontPage/service-center.jsp">服务中心 </a></li>
      <li><a href="${pageContext.request.contextPath}/FrontPage/news.jsp">新闻动态 </a></li>
      ...
      <li><a href="${pageContext.request.contextPath}/FrontPage/recruit.jsp">招贤纳士 </a></li>
	...
	<div class="am-container-1">
	 <div class="toppic-title left">
		...
		<div class="right toppic-progress">
			<span><a href="${pageContext.request.contextPath}/FrontPage/solutions.jsp" class="w-white">解决方案</a></span>
			<i class=" am-icon-arrow-circle-right w-white"></i>
			<span><a href="${pageContext.request.contextPath}/FrontPage/solutions-inform.jsp" class="w-white">方案详情</a></span>
		</div>
	</div>
</div>
        ...
        <li class="am-u-lg-4 am-u-md-4 am-u-sm-12 ">
            ...
            <div class="part-5-words2">
                <ul class="part-5-words2-ul">
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="${pageContext.request.contextPath}/FrontPage/solutions.jsp">解决方案</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="${pageContext.request.contextPath}/FrontPage/product-show.jsp">产品展示</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="${pageContext.request.contextPath}/FrontPage/customer-case.jsp">客户案例</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="${pageContext.request.contextPath}/FrontPage/service-center.jsp">服务中心</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="${pageContext.request.contextPath}/FrontPage/about-us.jsp">关于我们</a></li>
                    <li class="am-u-lg-4 am-u-md-6 am-u-sm-4"><a href="${pageContext.request.contextPath}/FrontPage/recruit.jsp">招贤纳士</a></li>
                    <div class="clear"></div>
                </ul>
            </div>
        </li>
