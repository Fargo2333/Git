...
<div class="toppic">
	 ...
	 <div class="toppic-title left">
			...
			<span class="toppic-title-span">扶贫创业资金申请</span>
			
		</div>
		<div class="right toppic-progress">
			<span><a href="${pageContext.request.contextPath}/FrontPage/solutions.jsp" class="w-white">扶贫绿色通道</a></span>
			<i class=" am-icon-arrow-circle-right w-white"></i>
			<span><a href="${pageContext.request.contextPath}/FrontPage/news-inform.jsp" class="w-white">扶贫创业资金申请</a></span>
		</div>
	</div>
</div>
...
<div class="am-container-1 margin-t30">
	<div class="words-title ">
		<span>国务院办公厅关于支持贫困县开展统筹整合使用财政涉农资金试点的意见</span>
		<div>2017-6-29</div>
	</div>
</div>
...
<div class="solution-inform">
	<div class=" solution-inform-content-all">
		<div class="solution-inform-content">
	      ...
	      <p class="solution-inform-content-words">各省（区、市）在连片特困地区县和国家扶贫开发工作重点县范围内，优先选择领导班子强、工作基础好、脱贫攻坚任务重的贫困县开展试点，试点贫困县数量不少于贫困县总数的三分之一，具备条件的可扩大试点范围。2017年，推广到全部贫困县。
	</p>
