...
<h1 align="center" id="btys">制定扶贫计划</h1><br>
<tr>
	<td>计划帮扶户数</td>
	<td><input type="text" name="tjhbfhs" value="${BftjList.tjhbfhs }"/></td>
</tr>
<tr>
	<td>计划每月走访户数</td>
	<td><input type="text" name="tjhzfhs" value="${BftjList.tjhzfhs }"/></td>
</tr>
<tr>
	<td>计划开展培训次数</td>
	<td><input type="text" name="tjhpxcs" value="${BftjList.tjhpxcs }"/></td>
</tr>
<tr>
	<td>计划争取扶贫项目</td>
	<td><input type="text" name="tjhfpxm" value="${BftjList.tjhfpxm }"/></td>
</tr>
</table>
<br/>
