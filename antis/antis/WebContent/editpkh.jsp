...
<form action="${pageContext.request.contextPath }/jcxx/updatepkh.action" method="post" >
<input type="hidden" name="id" value="${id}"/>
<br><br>
<center>
<h3 align="center" >修改贫困户</h3><br>
<table class="zdtable">
			<tr>
				<td>学生姓名</td>
				<td>	<input type="text" name="pxm" value="${PkhList.pxm }"/></td>
				<td>学号</td>
				<td>	<input type="text" name="pxh" value="${PkhList.pxh }"/></td>
				<td>专业</td>
				<td>	<input type="text" name="pzy" value="${PkhList.pzy }"/></td>
			</tr>
			<tr>
				<td>班级</td>
				<td>	<input type="text" name="pbj" value="${PkhList.pbj }"/></td>
				<td>性别</td>
				<td>	<input type="radio" name="pxb" value="男"><span>男</span>
				<input type="radio" name="pxb" value="女"><span>女</span></td>
				<td>年龄</td>
				<td>	<input type="text" name="pnl" value="${PkhList.pnl }"/></td>
			</tr>
			<tr>
				<td>家庭住址</td>
				<td>	<input type="text" name="pjtzz" value="${PkhList.pjtzz }"/></td>
				<td>身份证号码</td>
				<td>	<input type="text" name="psfz" value="${PkhList.psfz }"/></td>
				<td>联系电话</td>
				<td>	<input type="text" name="plxdh" value="${PkhList.plxdh }"/></td>
			</tr>
			<tr>
				<td>家庭人口</td>
				<td>	<input type="text" name="pjtrk" value="${PkhList.pjtrk }"/></td>
				<td>民族</td>
				<td>	<input type="text" name="pmz" value="${PkhList.pmz }"/></td>
				<td>家庭年收入（万）</td>
				<td>	<input type="text" name="pgold" value="${PkhList.pgold }"/></td>
			</tr>
			<tr>
				<td>主要致贫原因</td>
			...
			<tr>
				<td>主要致贫详细原因</td>
				<td colspan="5"><textarea rows="4" cols="50" name="pzyzpxxyy" class="form-control">${PkhList.pzyzpxxyy }</textarea></td>
			</tr>
		</table>
 <br>
