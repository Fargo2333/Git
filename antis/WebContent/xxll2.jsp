		...
		<div class="container-fluid">
			<div class="navbar-header">
			   ...
			   <ul class="nav nav-pills" style="display:table; margin:0 auto;margin-bottom:10px;"> 
					...
					<c:if test="${sessionScope.userschedule == '管理员'}"><c:if test="${sessionScope.userschedule == '管理员'}"><li role="presentation" class="active" ><a href="${pageContext.request.contextPath}/mb/mbdy.action">信息管理</a></li></c:if></c:if>
			 ...
			 <div class="panel panel-default">
			  <div class="panel-heading">信息浏览</div>
				<table class="table table-hover">
					<tr align="center" >								
						<td><h3>${MbList.mbt }</h3></td>
					</tr>
					<tr align="left" style="font-family: 微软雅黑;font-size:20px;height:450px;">								
						<td>${MbList.mnr }</td>
					</tr>		
				</table>
				</div>
				<a href="${pageContext.request.contextPath}/mb/xxll.action">返回</a>
				</div>
			</td>
		</tr>	
        </div>
