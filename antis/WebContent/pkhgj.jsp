...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" >			
		...
		<div class="xmright">
			 ...
			 <div class="panel panel-default">
			  <div class="panel-heading">贫困户跟进</div>
				<table class="table table-hover">
					...
					<c:forEach items="${PkhList}" var="pkh">
						<tr align="center" id="fptableheight">
							...
							<td>${pkh.pzt}</td>
							<td>${pkh.pgold}</td>
							<td><a href="${pageContext.request.contextPath}/jcxx/pkhgj2.action?id=${pkh.pid}">跟进<img src="${pageContext.request.contextPath}/images/edit.png" ></a></a></td>
						</tr>
					</c:forEach>
				</table>
				<center>
	...
	<a href="${pageContext.request.contextPath}/jcxx/pkhgj.action?pageNow=1">首页</a>
	<c:choose>
		<c:when test="${page.pageNow - 1 > 0}">
			<a href="${pageContext.request.contextPath}/jcxx/pkhgj.action?pageNow=${page.pageNow - 1}">上一页</a>
		</c:when>
		<c:when test="${page.pageNow - 1 <= 0}">
			<a href="${pageContext.request.contextPath}/jcxx/pkhgj.action?pageNow=1">上一页</a>
		</c:when>
	</c:choose>
	<c:choose>
		<c:when test="${page.pageNow + 1 < page.totalPageCount}">
			<a href="${pageContext.request.contextPath}/jcxx/pkhgj.action?pageNow=${page.pageNow + 1}">下一页</a>
		</c:when>
		<c:when test="${page.pageNow + 1 >= page.totalPageCount}">
			<a href="${pageContext.request.contextPath}/jcxx/pkhgj.action?pageNow=${page.totalPageCount}">下一页</a>
		</c:when>
	</c:choose>
	<a href="${pageContext.request.contextPath}/jcxx/pkhgj.action?pageNow=${page.totalPageCount}">尾页</a>
	</center>
</form>
</body>
</html>